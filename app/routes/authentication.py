...
def get_users_ownership():
    ...
    return Response(json.dumps(
        [{"email": email, "ownership_data": ownership_data} for email, ownership_data in ownership_data.items()]),
