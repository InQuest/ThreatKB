...
Revision ID: 421d2ad99d7f
Revises: 
Create Date: 2017-08-04 23:59:43.034278
...
def upgrade():
    ...
    op.create_index(op.f('ix_tags_mapping_source_id'), 'tags_mapping', ['source_id'], unique=False)
    op.create_index(op.f('ix_tags_mapping_source_table'), 'tags_mapping', ['source_table'], unique=False)
    op.create_index(op.f('ix_tags_mapping_tag_id'), 'tags_mapping', ['tag_id'], unique=False)
    ...
    op.create_index(op.f('ix_c2dns_domain_name'), 'c2dns', ['domain_name'], unique=False)
    op.create_index(op.f('ix_c2dns_state'), 'c2dns', ['state'], unique=False)
    ...
    op.create_index(op.f('ix_c2ip_ip'), 'c2ip', ['ip'], unique=False)
    op.create_index(op.f('ix_c2ip_state'), 'c2ip', ['state'], unique=False)
    ...
    op.create_index(op.f('ix_yara_rules_name'), 'yara_rules', ['name'], unique=False)
    op.create_index(op.f('ix_yara_rules_state'), 'yara_rules', ['state'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_yara_rules_state'), table_name='yara_rules')
    op.drop_index(op.f('ix_yara_rules_name'), table_name='yara_rules')
    ...
    op.drop_index(op.f('ix_c2ip_state'), table_name='c2ip')
    op.drop_index(op.f('ix_c2ip_ip'), table_name='c2ip')
    op.drop_table('c2ip')
    op.drop_index(op.f('ix_c2dns_state'), table_name='c2dns')
    op.drop_index(op.f('ix_c2dns_domain_name'), table_name='c2dns')
    op.drop_table('c2dns')
    op.drop_index(op.f('ix_tags_mapping_tag_id'), table_name='tags_mapping')
    op.drop_index(op.f('ix_tags_mapping_source_table'), table_name='tags_mapping')
    op.drop_index(op.f('ix_tags_mapping_source_id'), table_name='tags_mapping')
